...
- 1 = Ambiguous — need is partially clear but mixed with implementation, missing specifics, or missing affected personas. Or: personas named in prose but no per-persona user stories.
